...
public class Driver {
    public static void main(String[] args) {
        ...
        System.out.println(myPlaylist.getPlayListName());
        System.out.println();
        ...
        System.out.println();
        Track ourOwnTrack = new Track("HelloWorld", "CSstudents", 2020, 270);
        ...
        System.out.println();
        System.out.println( myPlaylist.playList.get(8).getTitle());
        System.out.println();
        System.out.println("And also get the artist duration and year");
        System.out.println( myPlaylist.playList.get(8).getArtist());
        System.out.println( myPlaylist.playList.get(8).getDuration());
        System.out.println( myPlaylist.playList.get(8).getYear());
        System.out.println("we can Also change these values");
        myPlaylist.playList.get(8).setTitle("Small Possibility Of Giving You Up");
        myPlaylist.playList.get(8).setArtist("Rock Ashtray");
        myPlaylist.playList.get(8).setYear(1789);
        myPlaylist.playList.get(8).setDuration(98989);
        System.out.println( myPlaylist.playList.get(8).getTitle());
        System.out.println( myPlaylist.playList.get(8).getArtist());
        System.out.println( myPlaylist.playList.get(8).getDuration());
        System.out.println( myPlaylist.playList.get(8).getYear());
